1. Since all compiled class files(From javac A1_G6_t1.java and javac A1_G6_t2.java) are stored in this directory, you need to set $CLASSPATH to include the current directory
